...
<head>
	...
	<title>About Us - TUMSDA Church</title>
		...
		<div class="side-panel-content">
			...
			<nav class="side-panel-nav">
				<ul class="side-panel-menu">
					...
					<li class="side-panel-item">
						<a class="side-panel-link active" href="/TUMSDA/about.php">
							<span>About Us</span>
						</a>
					</li>
					<li class="side-panel-item">
					...
					<li class="side-panel-item">
						<a class="side-panel-link " href="/TUMSDA/sermons.php">
							<span>Sermons</span>
						</a>
					</li>
					<li class="side-panel-item">
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse d-none d-lg-block" id="mainNav">
						<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
							...
							<li class="nav-item">
								<a class="nav-link active" href="/TUMSDA/about.php">About Us</a>
							</li>
							<li class="nav-item">
							...
							<li class="nav-item">
								<a class="nav-link " href="/TUMSDA/sermons.php">Sermons</a>
							</li>
							<li class="nav-item">
