	...
	<div class="sermons-hero-container">
		<div class="sermons-hero-overlay">
			<div class="sermons-hero-content">
				...
				<p class="sermons-hero-description">A collection of sermons and study materials to inspire, guide, and equip you in your spiritual journey. Access past messages, Bible study guides, and helpful resources.</p>
			</div>
		</div>
	</div>
</section>
					...
					<div class="resource-list">
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/icons/SS.png" alt="Sabbath School" class="resource-icon-img">
							</div>
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/icons/BS.jpeg" alt="Bible Study" class="resource-icon-img">
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/icons/PY.jpg" alt="Prayer" class="resource-icon-img">
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/icons/AB.png" alt="Adventist Beliefs" class="resource-icon-img">
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/icons/MP.png" alt="Music Philosophy" class="resource-icon-img">
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/icons/YA.jpg" alt="Young Adults" class="resource-icon-img">
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/icons/AP.png" alt="Adventist Pioneer" class="resource-icon-img">
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/icons/EGW.png" alt="EGW Writings" class="resource-icon-img">
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/icons/AA.jpeg" alt="Adventist Archives" class="resource-icon-img">
							</div>
							<div class="resource-content">
