	...
	<div class="container">
		...
		<div class="row g-4 justify-content-center">
			<div class="col-lg-4">
				<div class="leadership-card">
					<div class="leadership-image">
						<img src="assets/img/Hosea.jpg" alt="Elder Hosea Chesigor" class="leadership-photo">
					</div>
			...
			<div class="col-lg-4">
				<div class="leadership-card">
					<div class="leadership-image">
						<img src="assets/img/Derick.jpg" alt="Elder Derick Otieno" class="leadership-photo">
					</div>
					<div class="leadership-content">
			...
			<div class="col-lg-4">
				<div class="leadership-card">
					<div class="leadership-image">
						<img src="assets/img/Cephas.jpg" alt="Elder Cephas Mukaria" class="leadership-photo">
					</div>
					<div class="leadership-content">
